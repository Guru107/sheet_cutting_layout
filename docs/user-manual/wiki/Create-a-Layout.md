...
- Assuming a saved draft is already under review. It stays in `Draft` until `Submit for Check` is used.
- Skipping the final review and noticing mistakes only after the layout has been sent forward.
